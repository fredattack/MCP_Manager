...
import { Copy, Check, BookOpen, Terminal, MessageSquare, Key } from 'lucide-react';
import type { UserCredentials } from '@/types/admin';
...
export function McpSetupDrawer({
    isOpen,
    onClose,
    credentials,
    userName,
    mcpServerUrl = 'http://localhost:9978/mcp',
}: McpSetupDrawerProps) {
    ...
    return (
        <Sheet open={isOpen} onOpenChange={onClose}>
            <SheetContent className="w-full overflow-y-auto bg-white dark:bg-gray-900 sm:max-w-2xl">
                <SheetHeader>
                ...
                <div className="mt-6 space-y-6">
                    {/* Platform Selection */}
                            <div>
                                <label className="font-monologue-mono mb-3 block text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">
                                    Select Platform
                                </label>
                    ...
                    <div>
                        <div className="mb-2 flex items-center justify-between">
                            <label className="font-monologue-mono text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">
                                Configuration JSON
                            </label>
                            <button
                        ...
                        <pre className="font-monologue-mono overflow-x-auto rounded-lg bg-gray-900 p-4 text-xs text-green-400">
                            {mcpConfigJson}
                        </pre>
                    </div>
                    ...
                    {currentPlatform && (
                        <div>
                            ...
                            <div className="mb-4 rounded-lg bg-blue-50 p-3 dark:bg-blue-900/20">
                                <p className="font-monologue-mono mb-1 text-xs uppercase tracking-wide text-blue-700 dark:text-blue-400">
                                    Configuration File Location
                                </p>
                                {typeof currentPlatform.configPath === 'string' ? (
                                    <code className="font-monologue-mono text-sm text-blue-900 dark:text-blue-300">
                                        {currentPlatform.configPath}
                                    </code>
                                ) : (
                                    <div className="space-y-1">
                                        <div>
                                            <span className="font-monologue-mono text-xs text-blue-700 dark:text-blue-400">
                                                macOS:{' '}
                                            </span>
                                            <code className="font-monologue-mono text-sm text-blue-900 dark:text-blue-300">
                            ...
                            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                                <h4 className="font-monologue-mono mb-3 text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">
                                    Server Details
                                </h4>
                                <dl className="space-y-2">
                                    <div className="flex justify-between">
                                        <dt className="font-monologue-mono text-sm text-gray-600 dark:text-gray-400">Server Name:</dt>
                                        <dd className="font-monologue-mono text-sm text-gray-900 dark:text-white">
                                            {serverName}
                                        </dd>
                                    </div>
                                    <div className="flex justify-between">
                            ...
                            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900/50 dark:bg-blue-900/20">
                                <h4 className="font-monologue-serif mb-2 text-sm font-semibold text-blue-900 dark:text-blue-400">
                                    About the Python Bridge
                                </h4>
                                <p className="font-monologue-mono text-xs text-blue-800 dark:text-blue-300">
                                    The mcp_remote_client.py script converts STDIO communication (used by Claude Desktop)
                                    into HTTP requests to your Laravel MCP endpoint. Your credentials are passed as
                                    environment variables and used to authenticate with the server.
                                </p>
                            </div>
                </div>
            </SheetContent>
