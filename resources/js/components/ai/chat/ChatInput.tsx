...
export function ChatInput({
  ...
  return (
    <div className={`relative ${className}`}>
      {/* Commands tooltip */}
      {showCommands && (
        <div className="absolute bottom-full left-0 mb-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-3 text-sm z-10">
      ...
      <div className="flex flex-col bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm focus-within:border-blue-500 dark:focus-within:border-blue-400">
        {/* Model selector */}
        ...
        <div className="relative">
          <textarea
            ...
            maxLength={maxLength}
            rows={isExpanded ? 3 : 1}
            className="w-full px-3 py-3 bg-transparent border-none resize-none focus:outline-none text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
        ...
        <div className="flex items-center justify-between px-3 py-2 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 text-white rounded-md text-sm font-medium transition-colors disabled:cursor-not-allowed"
            >
              {disabled ? (
                <>
      ...
      {isExpanded && !disabled && (
        <div className="mt-1 text-xs text-gray-500 dark:text-gray-400 text-center">
          Press Cmd+Enter to send • / for commands
        </div>
      )}
    </div>
  );
