      ...
      <div className="flex h-[calc(100vh-4rem)] bg-white dark:bg-gray-900">
        ...
        {isCanvasVisible && (
          <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-800">
            <CanvasPanel
              selectedMessage={messages.find(m => m.id === selectedMessageId)}
  ...
  return (
    <div
      className={cn(
        ...
        message.role === 'user' 
          ? "bg-white dark:bg-gray-800 border-l-4 border-blue-500 shadow-sm hover:shadow-md" 
          : "bg-gray-50 dark:bg-gray-900 border-l-4 border-green-500",
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-900 dark:text-gray-100 whitespace-pre-wrap">
            {isStreaming ? (
              <>
                {message.content}
                <span className="inline-block w-2 h-4 bg-gray-900 dark:bg-gray-100 animate-pulse ml-1" />
              </>
            ) : (
              message.content
            )}
...
function CanvasPanel({ selectedMessage, content }: CanvasPanelProps) {
  if (!selectedMessage || selectedMessage.role !== 'assistant') {
    return (
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          <div className="mx-auto mb-4 h-12 w-12 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
            <svg className="h-6 w-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="h-full overflow-auto p-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            className="rounded-md p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            title="Export"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
