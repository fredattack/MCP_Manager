        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex items-start justify-between">
                    <div>
                        <h1 className="font-monologue-serif text-4xl font-normal tracking-tight text-gray-900 dark:text-white">User Management</h1>
                ...
                <div className="grid auto-rows-min gap-6 md:grid-cols-4">
                    <MonologueCard variant="elevated">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="font-monologue-mono text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Total Users</p>
                                <p className="font-monologue-serif mt-2 text-3xl font-normal text-gray-900 dark:text-white">{users.total}</p>
                            </div>
                    ...
                    <MonologueCard variant="elevated">
                        <div>
                            <p className="font-monologue-mono text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Active</p>
                    ...
                    <MonologueCard variant="elevated">
                        <div>
                            <p className="font-monologue-mono text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Locked</p>
                            <p className="font-monologue-serif mt-2 text-3xl font-normal text-gray-900 dark:text-white">
                    ...
                    <MonologueCard variant="elevated">
                        <div>
                            <p className="font-monologue-mono text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">Admins</p>
                            <p className="font-monologue-serif mt-2 text-3xl font-normal text-gray-900 dark:text-white">
                                    ...
                                    <tr key={user.id} className="group hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                        <td className="py-4">
                                            <div>
                                                ...
                                                <div className="font-monologue-mono text-xs text-gray-500 dark:text-gray-400">{user.email}</div>
                                            </div>
                                        </td>
                                        <td className="py-4">
                                            <span
                                                className={`inline-flex rounded-full px-2 py-1 text-xs font-medium ${getRoleBadgeColor(user.role)}`}
                                            >
