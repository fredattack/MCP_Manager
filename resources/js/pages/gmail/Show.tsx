...
export default function GmailShow({
    message = {
        id: '',
        subject: 'No message',
        body: '',
        ...
        <AppLayout>
            ...
            <div className="mx-auto max-w-4xl p-6">
                ...
                <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{message.subject}</h1>
                        <p className="mt-1 text-gray-600 dark:text-gray-400">From {message.from}</p>
                    </div>
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                                    ...
                                    {message.attachments.map((attachment, index) => (
                                        <div key={index} className="flex items-center justify-between rounded border p-2">
                                            <div>
                                                ...
                                                <span className="ml-2 text-sm text-gray-500">({Math.round(attachment.size / 1024)} KB)</span>
                                            </div>
                                            <Button variant="outline" size="sm">
                                                Download
                                            </Button>
                        ...
                        <div className="prose dark:prose-invert max-w-none">
                            <div dangerouslySetInnerHTML={{ __html: message.body }} className="whitespace-pre-wrap" />
                        </div>
                    </CardContent>
                </Card>
