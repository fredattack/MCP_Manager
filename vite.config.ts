    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/pages/daily-planning.tsx',
                'resources/js/pages/design-system.tsx',
                'resources/js/pages/jira.tsx',
                'resources/js/pages/jira-rq.tsx',
                'resources/js/pages/notion.tsx',
                'resources/js/pages/welcome.tsx',
                'resources/js/pages/ai/claude-chat.tsx',
                'resources/js/pages/ai/natural-language.tsx',
                'resources/js/pages/ai/nlp-demo.tsx',
                'resources/js/pages/integrations/google.tsx',
                'resources/js/pages/integrations/google-setup.tsx',
                'resources/js/pages/integrations/todoist.tsx',
                'resources/js/pages/integrations/todoist-setup.tsx',
