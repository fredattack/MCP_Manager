...
class Container_91c08e4ee4 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_91c08e4ee4 $container)
			{
	...
	public function createServiceContainer(): Container_91c08e4ee4
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/Users/fred/.config/herd-lite/bin/php',
