...
class Container_1470991198 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_1470991198 $container)
			{
	...
	public function createServiceContainer(): Container_1470991198
	{
		return $this;
	}
