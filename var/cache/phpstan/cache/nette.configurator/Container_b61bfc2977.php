...
class Container_b61bfc2977 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b61bfc2977 $container)
			{
	...
	public function createServiceContainer(): Container_b61bfc2977
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => '/private/var/folders/zz/fb5qt7ws7_l8rvtrtwd5lqt80000gn/T/hf3lui76rjha3NFwACb',
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/zz/fb5qt7ws7_l8rvtrtwd5lqt80000gn/T/hf3lui76rjha3NFwACb|1|/Users/fred/.config/herd-lite/bin:|*|/Users/fred/.config/herd-lite/bin/php.ini:/Users/fred/.config/herd-lite/bin/php.ini|3.4.2',
			],
		];
	}
