...
- Name: Authentication Flow >> user can logout successfully
- Location: /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/auth/login.spec.ts:16:3
...
Call log:
  - waiting for getByRole('textbox', { name: /email/i })
    ...
    at /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/auth/login.spec.ts:17:5
```
