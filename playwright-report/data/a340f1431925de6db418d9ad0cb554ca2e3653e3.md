...
- Name: GitLab Connection - OAuth Flow >> devrait afficher une erreur si les scopes requis sont insuffisants
- Location: /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/git/gitlab-connection.spec.ts:392:3
...
Call log:
  - waiting for getByRole('textbox', { name: /email/i })
    ...
    at /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/git/gitlab-connection.spec.ts:27:5
```
