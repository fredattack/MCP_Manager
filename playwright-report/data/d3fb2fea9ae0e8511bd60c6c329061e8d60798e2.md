...
- Name: Git Repository Management >> devrait afficher un état vide quand aucun repository n'est synchronisé
- Location: /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/git/repository-management.spec.ts:69:3
...
Call log:
  - waiting for getByRole('textbox', { name: /email/i })
    ...
    at /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/git/repository-management.spec.ts:39:5
```
