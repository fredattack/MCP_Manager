...
- Name: Authentication Flow >> user can login successfully
- Location: /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/auth/login.spec.ts:7:3
...
Call log:
  - waiting for getByRole('textbox', { name: /email/i })
    ...
    at /Users/fred/PhpstormProjects/mcp_manager/tests/e2e/auth/login.spec.ts:9:5
```
